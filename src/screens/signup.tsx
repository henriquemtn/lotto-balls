...
return (
  ...
  >
    ...
    <View className="w-1/2 h-full justify-center py-2">
      <Text className="text-white text-xl font-[MADEKenfolg]">Create a new account</Text>
      <Text className="text-[#5A626A] font-[MADEKenfolg]">
        Please enter your details!
      </Text>

      <View className="flex flex-row items-center px-4 w-full h-10  my-2 rounded-md border-2 border-[#D2D2D2]">
      ...
      <View className="flex flex-row items-center px-4 w-full h-10  mb-2 rounded-md border-2 border-[#D2D2D2]">
      ...
      <View className="flex w-full justify-center flex-row mt-2">
        <Text className="text-white text-[13px] font-[MADEKenfolg]">Already have an account?</Text>
        <TouchableOpacity onPress={() => navigation.navigate("SignIn")}>
          <Text className="text-[#C88D1B] text-[13px] ml-1 font-[MADEKenfolg]">Sign In</Text>
        </TouchableOpacity>
      </View>
    </View>
